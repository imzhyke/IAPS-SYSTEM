...
{
    public partial class Proprietor_CreateAccount : System.Web.UI.Page
    {
        ...
        protected void btn_Click1(object sender, EventArgs e)
        {
            ...
            if (lName != "" && fname != "" && uname != "" && pwd != "")
            {
                ...
                using (MySqlConnection connDB = new MySqlConnection(SQLConnectionString))
                {
                    ...
                    using (MySqlCommand cmd = new MySqlCommand("SELECT * FROM PROPRIETOR WHERE PROP_USRNAME = @username", connDB))
                    {
                        ...
                        else
                        {
                            rd.Close();
                            cmd.CommandType = CommandType.Text;
                            cmd.CommandText = "INSERT INTO PROPRIETOR (PROP_LNAME, PROP_FNAME, PROP_USRNAME, PROP_PASS) "
                                + " VALUES (@lName, @fName,@uname, @pwd)";
                            ...
                            if (ctr >= 1)
                            {
                                ...
                                ClientScript.RegisterClientScriptBlock(this.GetType(), "alert",
                                 "swal({\r\n    title: \"SUCCESS\",\r\n    text: \"Account created successfuly!\",\r\n    icon: \"success\",\r\n    type: \"success\"\r\n}).then(function() {\r\n    window.location = \"Proprietor_LogIn.aspx\";\r\n})", true);
